        ...
        data_source = {
                ...
                "parameters": {
                    ...
                    "fieldsMapping": {
                     ...
                     #'https://travel-openai.openai.azure.com/', 
...
def conversation_internal(request_body):
    # try:
    #     if SHOULD_STREAM:
    #         result =  stream_chat_request(request_body)
    #         response = make_response(format_as_ndjson(result))
...
def conversation(req: func.HttpRequest) -> func.HttpResponse:
    #if not req.is_json():
        #return func.HttpResponse(json.dumps({"error": "request must be json"}), 415)
